...
export const user: IUser = {
  ...
  responseRate: "98%",
  description: "Занимаюсь сдачей строительного инструмента в аренду уже более 5 лет. Всё оборудование в отличном состоянии, прохожу регулярное техническое обслуживание. Работаю по всей Москве — доставка в день заказа.",
  reviews: [
    {
      id: 1,
      author: "Иван К.",
