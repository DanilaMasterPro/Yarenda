...
const sections = [
  ...
  {
    title: "3. ЗАБЕРИТЕ ИЛИ ПОЛУЧИТЕ ДОСТАВКУ",
    description:
  ...
  {
    title: "4. ПОЛЬЗУЙТЕСЬ И ВОЗВРАЩАЙТЕ",
    description:
        ...
        <div className="space-y-24">
          {sections.map((section, index) => (
            ...
            >
              ...
              <div
                className={`fade-in order-1 ${section.imagePosition === "right" ? "lg:order-2" : "lg:order-1"}`}
              >
              ...
              {/* Text Content */}
              <div
                className={`fade-in order-2 ${section.imagePosition === "right" ? "lg:order-1" : "lg:order-2"}`}
              >
